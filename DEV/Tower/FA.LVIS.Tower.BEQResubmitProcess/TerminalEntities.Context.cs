...
namespace FA.LVIS.Tower.BEQResubmitProcess
{
    ...
    public partial class TerminalEntities : DbContext
    {
        ...
        public virtual DbSet<DocumentMap_Backup> DocumentMap_Backup { get; set; }
        ...
        public virtual ObjectResult<GetExceptionInfo_Result> GetExceptionInfo(Nullable<System.DateTime> startdate, Nullable<System.DateTime> enddate, Nullable<int> exceptiongroupid, Nullable<int> tenantId, Nullable<bool> isincluderesolved)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetExceptionInfo_Result>("GetExceptionInfo", startdateParameter, enddateParameter, exceptiongroupidParameter, tenantIdParameter, isincluderesolvedParameter);
        }
