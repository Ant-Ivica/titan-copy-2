	...
	.directive('phonenumberDirective', ['$filter', function($filter) {
		...
		*/
		...
		return {
			...
			template: '<input name="Phone" ng-model="inputValue" style="text-align: left; min-width: 195px;padding: 1px 0;line-height: 1em;" type="tel" class="input" placeholder="{{phonenumberPlaceholder}}" title="Phonenumber (Format: (999) 9999-9999)">',
       	};
	}])
