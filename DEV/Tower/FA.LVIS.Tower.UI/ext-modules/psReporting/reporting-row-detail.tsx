...
const ReportingComponent: React.FC<ReportingProps> = ({ data, activeCustomerName, onRowSelectionChange }) => {
    ...
    return (
        <div>
            <Table
                ...
                columns={columns}
                dataSource={data.filter(row => row.CustomerId === activeCustomerName)}
